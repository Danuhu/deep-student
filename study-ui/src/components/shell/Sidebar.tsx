...
export function Sidebar({
  ...
  const primaryItems = [
    { id: "new-conversation", label: "新对话", icon: <ChatCenteredText size={18} />, active: true },
  ...
  return (
    ...
    >
      <div className="flex h-full flex-col">
        ...
        <div className="custom-scrollbar min-w-0 flex-1 overflow-y-auto overflow-x-hidden px-2 py-1">
          {currentMode === "app" ? (
