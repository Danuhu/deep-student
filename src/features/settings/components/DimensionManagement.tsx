      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center sm:justify-between gap-2">
        ...
        <div className="flex items-center gap-1.5 w-full sm:w-auto">
          <DsButton
            ...
            className="flex-1 sm:flex-none [@media(pointer:coarse)]:!h-11"
          >
      ...
      <div>
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-start justify-center py-12 px-4 border border-dashed rounded-lg bg-muted/5">
            ...
            <DsButton onClick={handleOpenCreateDialog} variant="outline" size="sm" className="[@media(pointer:coarse)]:!h-11">
