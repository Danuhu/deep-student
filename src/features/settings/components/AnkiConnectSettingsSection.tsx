  ...
  if (compact) {
    return (
      <div className="space-y-3">
        ...
        <DsButton size="sm" variant="outline" className="whitespace-normal [@media(pointer:coarse)]:!min-h-11" onClick={testConnection} disabled={!settings.anki_connect_enabled || testing}>
