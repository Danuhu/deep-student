...
export function AppMenu({ open, onOpenChange, mode = 'dropdown', overlayOwnerId, className, children }: AppMenuProps) {
  ...
  return (
    <AppMenuContext.Provider value={{ open: actualOpen, setOpen, triggerRef: containerRef, contentRef, menuId, mode, position, setPosition, openIntentRef, overlayOwnerId: resolvedOverlayOwnerId }}>
